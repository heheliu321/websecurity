package com.itheima.crypt.util;

import com.itheima.crypt.KaiserDemo;
import com.itheima.crypt.Util;
...
public class FrequencyAnalysis {
	...
	public static void main(String[] args) throws Exception {
		...
		//读取加密后的文件
	    String artile = com.itheima.crypt.Util.file2String("article_en.txt");
	    //解密（会生成多个备选文件）
	    decryptCaesarCode(artile, "article_de.txt");
	}
	
	public static void printCharCount(String path) throws IOException{
		String data = com.itheima.crypt.Util.file2String(path);
	...
	public static void encryptFile(String srcFile, String destFile, int key) throws IOException {
		String artile = com.itheima.crypt.Util.file2String(srcFile);
		//加密文件
		String encryptData = KaiserDemo.encrypt(artile, key);
		//保存加密后的文件
		com.itheima.crypt.Util.string2File(encryptData, destFile);
	}
